...
public class CutsceneMovement : MonoBehaviour 
{
    ...
    public bool canPickup = false; // indicates if the user is near the power up
    ...
    void Update()
    {
        ...
        //If you press E nearby the phone 
        //Set pickedUp to true
        //Which loads the cutscene in SwitchToGame script.
    ...
    { // jumping logic & animations
        _rB.velocity = new Vector2(_rB.velocity.x, _jumpPower * 1);
        _isGrounded = false;
